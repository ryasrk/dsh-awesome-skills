...
export interface OrtTensor {
    new (type: string, data: BigInt64Array | Float32Array | Uint8Array | Int8Array | Uint32Array | Int32Array, dims: number[]): OrtTensorInstance;
}
...
export interface OrtStatic {
    InferenceSession: {
        create(model: Uint8Array, options?: OrtSessionOptions): Promise<OrtSession>;
    };
    Tensor: OrtTensor;
    env: OrtEnv;
}
...
//# sourceMappingURL=ort-types.d.ts.map